...
static void *ov6_0224509C(Pokemon *param0, PokemonSpriteTemplate *param1, u32 param2);
static void *ov6_022450E4(PokemonSpriteTemplate *param0, u32 param1);
...
static void ov6_02245D10(SysTask *param0, void *param1)
{
    ...
    if (v1->unk_10) {
        ...
        if (v1->unk_18.unk_08 != NULL) {
            SpriteList_Update(v1->unk_18.unk_08);
        }
    }
}

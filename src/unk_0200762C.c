...
void sub_02007DEC(PokemonSprite *param0, int param1, int param2)
{
    ...
    case 38:
        ...
        break;
    case 40:
        param0->transforms.mosaicValue = param2;
        param0->needReloadChar = TRUE;
        break;
    case 41:
...
int sub_020080C0(PokemonSprite *param0, int param1)
{
    ...
    case 40:
        return param0->transforms.mosaicValue;
    case 41:
                ...
                for (v3 = 0; v3 < 80; v3++) {
                    for (v2 = 0; v2 < 160 / 2; v2++) {
                        if (v2 < 160 / 4) {
                            ...
                            } else if (param0->sprites[v1].transforms.mosaicValue) {
                                if (v3 % (param0->sprites[v1].transforms.mosaicValue * 2)) {
                                    param0->charRawData[v3 * 0x80 + v2 + 0x50] = param0->charRawData[(v3 - 1) * 0x80 + v2 + 0x50];
                                } else {
                                    if (v2 % (param0->sprites[v1].transforms.mosaicValue)) {

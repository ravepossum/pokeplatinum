...
static void PrintSkillsStat(PokemonSummaryScreen *summaryScreen, int statType, int windowNum);
...
static void PrintSkillsStat(PokemonSummaryScreen *summaryScreen, int statType, int windowNum)
{
    ...
    PrintStringToWindow(summaryScreen, &summaryScreen->extraWindows[windowNum], color, ALIGN_RIGHT);
}
...
static void DrawSkillsPageWindows(PokemonSummaryScreen *summaryScreen)
{
    ...
    PrintSkillsStat(summaryScreen, STAT_ATTACK, SUMMARY_WINDOW_ATTACK);
    ...
    PrintSkillsStat(summaryScreen, STAT_DEFENSE, SUMMARY_WINDOW_DEFENSE);
    ...
    PrintSkillsStat(summaryScreen, STAT_SPECIAL_ATTACK, SUMMARY_WINDOW_SP_ATTACK);
    ...
    PrintSkillsStat(summaryScreen, STAT_SPECIAL_DEFENSE, SUMMARY_WINDOW_SP_DEFENSE);

    SetAndFormatNumberBuf(summaryScreen, PokemonSummary_Text_TemplateSpeed, summaryScreen->monData.speed, 3, PADDING_MODE_NONE);
    PrintSkillsStat(summaryScreen, STAT_SPEED, SUMMARY_WINDOW_SPEED);
